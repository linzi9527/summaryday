...
public interface IDynamicBaseDao {
	 ...
	 * @throws Exception
	 */
	public List<?>    query(DBSetting dBSetting,Class<?> c,boolean isCache) throws Exception;
	 ...
	 * @throws Exception
	 */
	public List<?>    querys(DBSetting dBSetting,Class<?> c,boolean isCache) throws Exception;
	 ...
	 */
	public List<?> queryList(DBSetting dBSetting,Class<?> o,String isWhere,boolean isCache) throws Exception;
	 ...
	 * @return
	 */
	public List<?>    query(DBSetting dBSetting,Class<?> c,String params,boolean isCache) throws Exception;
	/**
	 * 根据ID获取某个实体
	 * @param id
	 * @param o--
	 ...
	 */
	  ...
	  * @throws Exception
	  */
	 public int[] createTables(DBSetting dBSetting,List<String> sqlList)throws Exception;
	  ...
	  * @throws Exception
	  */
	 public List<?> queryByOracle(DBSetting dBSetting,Class<?> o,int p1,int p2,String desc) throws Exception;
	  ...
	  * @throws SQLException
	  */
	 public  <T> List<T> queryList(DBSetting dBSetting,Class<T> resultClass,String isWhere,boolean isCache, Object... obj)  throws SQLException;
	  ...
	  * @throws SQLException
	  */
	 public  List<?> queryByList(DBSetting dBSetting,Class<?> resultClass,String isWhere,boolean isCache, Object... obj)  throws SQLException;
	...
	public Map<String,Object> queryMap(DBSetting dBSetting,String sql);
	 ...
	 ////////////////////////////////////////////////////////////////////////////////
		...
		public   boolean    saveByTransaction(DBSetting dBSetting,Object[] o, String tableName) throws Exception;
